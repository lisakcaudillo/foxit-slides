...
const nextConfig: NextConfig = {
  // Allow native .node modules (Foxit SDK) to work server-side
  serverExternalPackages: ['@foxitsoftware/foxit-pdf-sdk-node', '@foxitsoftware/foxit-pdf-conversion-sdk-node'],
